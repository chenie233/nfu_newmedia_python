...
<br/>数据来源(https://www.juhe.cn/)
<br/>API来源(http://api.juheapi.com/japi/toh?key=4bc027ace0535ecf7e935870a1b9deef&v=1.0&month=11&day=1) 
...
下行输入日期
## 输出：
用户得到输出结果为：历史上的某一天发生了什么(选取前五件事情)详见[new_file.py](new_file.py)
## 从输入到输出，本组作品使用了：
### 模块
